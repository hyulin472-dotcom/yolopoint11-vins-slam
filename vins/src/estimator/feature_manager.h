...
class FeaturePerId
{
  public:
    ...
    int start_frame;
    int anchor_camera_id;
    vector<FeaturePerFrame> feature_per_frame;
    int used_num;
    double estimated_depth;
    int solve_flag; // 0 haven't solve yet; 1 solve succ; 2 solve fail;

    FeaturePerId(int _feature_id, int _start_frame, int _anchor_camera_id = 0)
        : feature_id(_feature_id), start_frame(_start_frame), anchor_camera_id(_anchor_camera_id),
